...
insert into public.committees (id, name, chair, mandate, members) values
  ...
  ('c-appointment', 'Committee on Appointment', 'Hon. Jeffrey Owusu Acheaw', 'Reviews and recommends appointments to Senate offices, committees, and other governance positions.', '[{"name":"Hon. Jeffrey Owusu Acheaw","role":"Chairperson"},{"name":"Hon. Oppong Palmer-Buckle Charles","role":"Vice Chairperson"},{"name":"Hon. Genevieve Owusuwaa Karikari","role":"Clerk to the Committee"},{"name":"Hon. Herbert Boadu Ayisi","role":"Member"},{"name":"Hon. Dorian Esi Fynn","role":"Member"}]'::jsonb),
  ('c-budget', 'Committee on Budget and Finance', 'Hon. Nana Kwame Appiah Owusu', 'Scrutinises the association budget, financial reports, and fiscal policy proposals laid before the Senate.', '[{"name":"Hon. Nana Kwame Appiah Owusu","role":"Chairperson"},{"name":"Hon. Derrick Appiah","role":"Vice Chairperson"},{"name":"Hon. Sawudatu Ibrahim","role":"Clerk to the Committee"},{"name":"Hon. Benedicta Akosua Gyebuah Cobbina","role":"Ranking Member"},{"name":"Hon. Genevieve Owusuwaa Karikari","role":"Ranking Member"},{"name":"Hon. Kindly Osei Bediako","role":"Member"}]'::jsonb),
...
insert into public.news_items (id, title, date, category, excerpt) values
  ('n1', 'Senate Approves Digital Governance Portal Initiative', '2026-05-12', 'Official Statement', 'The Senate ratified the digital governance infrastructure project to strengthen transparency and public access to legislative records.'),
  ('n2', 'Committee Reports Published for Q1 2026', '2026-05-01', 'Notice', 'Quarterly committee reports have been lodged with the Clerk and are available for review by members of the House.')
on conflict (id) do nothing;
